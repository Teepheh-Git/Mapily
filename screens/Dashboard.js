...
import {Animated, Image, Platform, SafeAreaView, ScrollView, Text, TouchableOpacity, View} from 'react-native';
        ...
        return (
            <View style={{
                ...
                <TouchableOpacity onPress={() => console.log("profile")}>
                    ...
                    <Image source={images.profile_pic} resizeMode={"contain"}
                    ...
                    if (index === 0 || index === countries.length - 1) {
                        ...
                        return (
                            <Animated.View
                                ...
                                <Animated.Image source={item.image} resizeMode={"contain"} style={{
                                    width: mapSize,
                                    height: mapSize,
                                ...
                                <Animated.Text style={{
                                    marginTop: 3, color: COLORS.white, ...FONTS.h1, fontSize: fontSize
                                }}>
                                    {item.name}
                                </Animated.Text>
                        ...
                        return (
                            ...
                            >
                                ...
                                <View style={{
                                    ...
                                    <TextButton label={"Explore"} customContainerStyle={{
                                        position: 'absolute',
                                        bottom: -20,
                                        width: 150
